...
export const CraftDocumentorRegistrationStatus = () => {
  ...
  if (session.status === "authenticated" && documentorData) {
    const isApproved = documentorData.isActive === true;
    ...
    return (
      <Card className="overflow-hidden border-gray-200 shadow-sm">
        ...
        <CardHeader className="pb-2">
          <div className="mb-2 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-xl">
                {isApproved
                  ? "Craft Documentor Profile Approved"
                  : "Craft Documentor Application Under Review"}
              </CardTitle>
            </div>
          ...
          <CardDescription>
            {isApproved
              ? "Congratulations! Your craft documentor profile has been approved. You can now access the dashboard."
              : "Your craft documentor application is currently being reviewed by our team. We'll notify you once there's an update."}
          </CardDescription>
        </CardHeader>
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                >
                  {isApproved
                    ? "Your craft documentor profile has been approved. You're now a verified craft documentor on our platform."
          ...
          <div className="mt-4 space-y-8">
            ...
            <div className="flex flex-col items-center gap-6 lg:flex-row lg:items-start">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                >
                  {isApproved ? "VERIFIED DOCUMENTOR" : "VERIFICATION PENDING"}
                </Badge>
              </div>
            </div>
          ...
          <div className="mt-8 flex justify-center gap-4 border-t border-gray-200 pt-4">
            {isApproved && (
              <Button variant="default" asChild>
                <Link href="/dashboard/craft-documentor" target="_blank">
                  <CheckCircle className="mr-2 h-4 w-4" />
                  Go to Craft Documentor Dashboard
                </Link>
              </Button>
            )}
    ...
    return (
      <Card className="border-gray-200 shadow-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            Join our network of craft documentors or check your application status
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex flex-col space-y-4 rounded-xl border border-primary/10 bg-primary/5 p-6">
              ...
              <p className="text-center text-sm text-gray-600">
                If you&apos;ve already submitted a craft documentor
            ...
            <div className="flex flex-col space-y-4 rounded-xl border border-primary/10 bg-primary/5 p-6">
              ...
              <h3 className="text-center text-lg font-medium">
                New Craft Documentor?
              </h3>
              <p className="text-center text-sm text-gray-600">
                If you&apos;re looking to document crafts on our
    ...
    <Card className="border-gray-200 shadow-sm">
      <CardHeader className="space-y-1">
        <div className="flex items-center gap-2">
          ...
          <CardTitle>Craft Documentor Application Form</CardTitle>
        </div>
        <CardDescription>
          Please fill in the details below to register as a craft documentor
        </CardDescription>
      </CardHeader>
      <CardContent>
        <CraftDocumentorForm />
